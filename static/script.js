function startQuiz() {
  ...
  function recordAnswer(selectedIndex) {
    ...
    const questionType = currentQuestion % 4;
  ...
  function showResults() {
    ...
    const drinkRecommendation = createElement(
      "div",
    ...
    const homeButton = createElement("button", "About");
    homeButton.classList.add("option");
    homeButton.addEventListener("click", () => {
      window.location.href = "/about"; // Link to your about page
    });
